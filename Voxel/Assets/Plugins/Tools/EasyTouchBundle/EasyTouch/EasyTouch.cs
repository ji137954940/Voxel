...
public class EasyTouch : MonoBehaviour {
    ...
    /// </summary>
    public bool longTapSupportDrag = false;
	...
	void UpdateTouches(bool realTouch, int touchCount){
        ...
        if (realTouch || enableRemote)
        {
			...
			for (var i = 0; i < touchCount; ++i) {
                ...
                //        UnityEngine.Debug.LogError("i:" + i + "_____" + (Input.GetTouch(0).phase == TouchPhase.Began) + "___" + (Input.GetTouch(1).phase == TouchPhase.Began));
                //        UnityEngine.Debug.LogError(Input.GetTouch(0).position + "___" + fingers[0].position);
                //        if (fingers[1] != null)
                //        {
                //            UnityEngine.Debug.LogError(Input.GetTouch(1).position + "___" + fingers[1].position);
                //        }
                //        int xx = 0;
                //        xx++;
                //    }
                ...
                //string s = "";
                //for (int fff = 0; fff < Input.touchCount; fff++)
                //{
                //    s += Input.GetTouch(fff).position+"("+ Input.GetTouch(fff) .fingerId+ ")"+"____";
                //}
                //s += "................";
                //for (int fff = 0; fff < fingers.Length; fff++)
                //{
                //    if (fingers[fff] != null)
                //    {
                //        s += fingers[fff].position + "(" + fingers[fff].fingerIndex + ")___";
                //    }
                //}
                //UnityEngine.Debug.LogError(Input.touchCount + ":" + s);
                ...
                //UnityEngine.Debug.LogError("____" + i + ":" + fingers[i].deltaPosition);
			...
			while (i<touchCount){
                ...
                //UnityEngine.Debug.LogError(Input.touchCount + ":" + touchCount+":"+i+":"+fingers[i].deltaPosition);
