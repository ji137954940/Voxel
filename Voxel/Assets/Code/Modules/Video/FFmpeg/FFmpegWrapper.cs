...
namespace FFmpeg
{
    public class FFmpegWrapper : MonoBehaviour
    {
        ...
        {
            Debug.Log("  123 " + Time.realtimeSinceStartup);
            ...
            //using (var p = new AndroidJavaClass("com.github.hiteshsondhi88.libffmpeg.FFmpeg"))
            //    _plugin = p.CallStatic<AndroidJavaObject>("getInstance", unityClass.GetStatic<AndroidJavaObject>("currentActivity"));

            //bool b = _plugin.Call<bool>("isFFmpegCommandRunning");


            //Debug.Log(" 123   " + cmd + "   "+ Time.realtimeSinceStartup + " b " + b);
