...
namespace Color.Number.Animation
{
    ...
    public class UniGifDecoder
    {
        ...
        public static void DecodeTextureCoroutine(GifAnimation.GifData gifData, List<GifAnimation.GifTexture> gifTexList, FilterMode filterMode, TextureWrapMode wrapMode)
        {
            ...
            foreach (var imgBlock in gifData.imageBlockList)
            {
                ...
                gifTexList.Add(new GifAnimation.GifTexture(tex, delaySec));
        ...
        static bool DecodeTexture(GifAnimation.GifData gifData, List<GifAnimation.GifTexture> gifTexList, FilterMode filterMode, TextureWrapMode wrapMode)
        {
            if (gifData.imageBlockList == null || gifData.imageBlockList.Count < 1)
            {
                return false;
            ...
            foreach (var imgBlock in gifData.imageBlockList)
            {
                ...
                if (gifTexList == null)
                {
                    gifTexList = new List<GifAnimation.GifTexture>();
                }
                gifTexList.Add(new GifAnimation.GifTexture(tex, delaySec));
        ...
        /// </summary>
        static Color32? GetGlobalBgColor(GifAnimation.GifData gifData)
        {
            ...
            if (gifData.globalColorTableFlag)
            {
                ...
                bgColor = new Color32(bgRgb[0], bgRgb[1], bgRgb[2], 0);
            }
            return bgColor;
        }
        ...
        /// </summary>
        static byte[] GetDecodedData(GifAnimation.ImageBlock imgBlock)
        {
        ...
        /// </summary>
        static List<byte[]> GetColorTable(GifAnimation.GifData gifData, GifAnimation.ImageBlock imgBlock, ref Color32? bgColor)
        {
        ...
        /// </summary>
        static GifAnimation.GraphicControlExtension? GetGraphicCtrlExt(GifAnimation.GifData gifData, int imgBlockIndex)
        {
        ...
        /// </summary>
        static int GetTransparentIndex(GifAnimation.GraphicControlExtension? graphicCtrlEx)
        {
        ...
        /// </summary>
        static float GetDelaySec(GifAnimation.GraphicControlExtension? graphicCtrlEx)
        {
        ...
        /// </summary>
        static ushort GetDisposalMethod(GifAnimation.GraphicControlExtension? graphicCtrlEx)
        {
        ...
        /// </summary>
        static Texture2D CreateTexture2D(GifAnimation.GifData gifData, List<GifAnimation.GifTexture> gifTexList, int imgBlockIndex, ushort disposalMethod, FilterMode filterMode, TextureWrapMode wrapMode, ref bool useBeforeTex)
        {
            // Create texture
        ...
        /// </summary>
        static void SetTexturePixelRow(Texture2D tex, int y, GifAnimation.ImageBlock imgBlock, byte[] decodedData, ref int dataIndex, List<byte[]> colorTable, Color32? bgColor, int transparentIndex, bool useBeforeTex)
        {
            // Row no (0~)
