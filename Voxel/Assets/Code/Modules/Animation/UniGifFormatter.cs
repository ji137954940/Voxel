...
namespace Color.Number.Animation
{
    ...
    public class UniGifFormatter
    {
        ...
        public static bool SetGifData(byte[] gifBytes, ref GifAnimation.GifData gifData)
        {
        ...
        static bool SetGifHeader(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            // Signature(3 Bytes)
            // 0x47 0x49 0x46 (GIF)
        ...
        static bool SetGifBlock(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            try
            {
                int lastIndex = 0;
        ...
        static void SetImageBlock(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            GifAnimation.ImageBlock ib = new GifAnimation.ImageBlock();
            ...
            while (true)
            {
                ...
                var imageDataBlock = new GifAnimation.ImageBlock.ImageDataBlock();
                ...
                {
                    ib.imageDataList = new List<GifAnimation.ImageBlock.ImageDataBlock>();
                }
            ...
            {
                gifData.imageBlockList = new List<GifAnimation.ImageBlock>();
            }
            gifData.imageBlockList.Add(ib);
        }

        static void SetGraphicControlExtension(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            GifAnimation.GraphicControlExtension gcEx = new GifAnimation.GraphicControlExtension();
            ...
            {
                gifData.graphicCtrlExList = new List<GifAnimation.GraphicControlExtension>();
            }
            gifData.graphicCtrlExList.Add(gcEx);
        }

        static void SetCommentExtension(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            GifAnimation.CommentExtension commentEx = new GifAnimation.CommentExtension();
            ...
            while (true)
            {
                ...
                var commentDataBlock = new GifAnimation.CommentExtension.CommentDataBlock();
                ...
                {
                    commentEx.commentDataList = new List<GifAnimation.CommentExtension.CommentDataBlock>();
                }
            ...
            {
                gifData.commentExList = new List<GifAnimation.CommentExtension>();
            }
            gifData.commentExList.Add(commentEx);
        }

        static void SetPlainTextExtension(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            GifAnimation.PlainTextExtension plainTxtEx = new GifAnimation.PlainTextExtension();
            ...
            while (true)
            {
                ...
                var plainTextDataBlock = new GifAnimation.PlainTextExtension.PlainTextDataBlock();
                ...
                {
                    plainTxtEx.plainTextDataList = new List<GifAnimation.PlainTextExtension.PlainTextDataBlock>();
                }
            ...
            {
                gifData.plainTextExList = new List<GifAnimation.PlainTextExtension>();
            }
            gifData.plainTextExList.Add(plainTxtEx);
        }

        static void SetApplicationExtension(byte[] gifBytes, ref int byteIndex, ref GifAnimation.GifData gifData)
        {
            // Extension Introducer(1 Byte)
            // 0x21
            ...
            while (true)
            {
                ...
                var appDataBlock = new GifAnimation.ApplicationExtension.ApplicationDataBlock();
                ...
                {
                    gifData.appEx.appDataList = new List<GifAnimation.ApplicationExtension.ApplicationDataBlock>();
                }
